...
deployment               = "docker-ee" # VM/Hostname prefix string. Prepended to all resources & is name of Azure RG
...
docker_ee_subscriptions_ubuntu = "sub-00000000-0000-0000-0000-000000000000" # URL from Docker Hub -> My Content -> Trial Sub (is in URL)

# Docker UCP Version and Configuration
###################################
docker_ucp_version        = "3.1.2"
docker_ucp_license_path   = "./docker_subscription.lic" # Download from Docker Hub -> My Content and place in root directory
...
# AzureAD App w/Contributor permissions for either the Azure Sub or Azure RG listed in deployment variable (above)
...
enable_kubernetes_azure_load_balancer = true
