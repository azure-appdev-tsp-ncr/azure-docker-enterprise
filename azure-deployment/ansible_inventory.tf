...
locals {
  ...
  enable_kubernetes_cloud_provider = "${ var.enable_kubernetes_cloud_provider != "" ?
    ( var.enable_kubernetes_cloud_provider == "true" ? true : false ) :
    ( var.enable_kubernetes_azure_disk || var.enable_kubernetes_azure_load_balancer ||
      local.lookup_kubernetes_cloud_provider ) }"

  kubernetes_orchestrator = "${ var.kubernetes_orchestrator != "" ?
    var.kubernetes_orchestrator : local.lookup_kubernetes_orchestrator_version }"
}
